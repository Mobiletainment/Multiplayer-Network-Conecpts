...
namespace cocos2d	{
	class slCocosUtil_API CCNumber : public CCObject {
	private:
		int m_nValue;
		double m_dValue;
	public:
		...
		void setValue(double v)  { m_nValue=(int)v; m_dValue=v;}
	};
	...
	class slCocosUtil_API CCNull : public CCObject {
	public:
