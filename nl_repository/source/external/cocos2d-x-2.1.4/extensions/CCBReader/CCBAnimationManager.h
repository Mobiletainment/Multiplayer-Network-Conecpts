...
class CC_DLL CCBAnimationManager : public CCObject
{
private:
    CCArray *mSequences;
...
class CC_DLL CCBSetSpriteFrame : public CCActionInstant
{
private:
...
class CC_DLL CCBSoundEffect : public CCActionInstant
{
private:
...
class CC_DLL CCBRotateTo : public CCActionInterval
{
private:
    float mStartAngle;
    float mDstAngle;
...
class CC_DLL CCBRotateXTo: public CCActionInterval {
private:
    float mStartAngle;
    float mDstAngle;
    float mDiffAngle;
...
class CC_DLL CCBRotateYTo: public CCActionInterval {
private:
    float mStartAngle;
    float mDstAngle;
    float mDiffAngle;
...
class CC_DLL CCBEaseInstant : public CCActionEase
{
public:
