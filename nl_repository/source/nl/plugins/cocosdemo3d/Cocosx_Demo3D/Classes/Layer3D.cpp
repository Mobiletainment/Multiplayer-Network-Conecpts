...
void Layer3D::draw()
{
	...
	CCGLProgram* shader(this->getShaderProgram());
	...
	GLint matrixId(shader->getUniformLocationForName("CC_MVPMatrix"));
    shader->setUniformLocationWithMatrix4fv(matrixId, matrixMVP.mat, 1);
